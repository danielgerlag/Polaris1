...
namespace S1.API
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            AppCore.IoC.Container.Resolve<IIndexRegister>().RegisterEntityTypes(typeof(S1Context).Assembly); //hack
        ...
        public void ConfigureIoC()
        {
            ...
            builder.AddSearchIndexers(typeof(S1Context).Assembly);  //hack
