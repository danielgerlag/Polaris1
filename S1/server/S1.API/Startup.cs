...
[assembly: OwinStartup(typeof(S1.API.Startup))]
...
namespace S1.API
{
    public class Startup
    {
        ...
        {
            var manager = new AppUserManager(new UserStore<AppUser, AppRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>(context.Get<TenantContext>()));
