...
{
    public class S1Init : CreateDatabaseIfNotExists<S1Context>
    {

        protected override void Seed(S1Context context)
        {
            ...
            context.WorkItemStatuses.Add(new WorkItemStatus() { Code = "OPEN", Name = "Open", IsOpen = true });
